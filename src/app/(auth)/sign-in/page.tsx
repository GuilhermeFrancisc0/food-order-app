...
const SignIn = () => {
    ...
    const signInGoogle = async () =>  await googleSignIn();
    ...
    return (
        ...
        >
            <div className="card bg-white p-10 shadow-xl w-96">
                ...
                <span className='text-primary select-none text-center mb-4'>
                ...
                >
                    <svg className="" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
